...
@onready var game_ui: GameUi = $"Game UI/Game UI"
...
func move_box(box_tile: Vector2i, md: Vector2i) -> void:
	...
	boxes_tiles.set_cell(dest, SOURCE_ID, get_atlas_coordinates(tlt))
...
func get_atlas_coordinates(lt: TileLayers.LayerType) -> Vector2i:
	match lt:
...
func add_tile(lt: TileLayers.LayerType, tc: Vector2i, map: TileMapLayer) -> void:
	var atlas_coord: Vector2i = get_atlas_coordinates(lt)
